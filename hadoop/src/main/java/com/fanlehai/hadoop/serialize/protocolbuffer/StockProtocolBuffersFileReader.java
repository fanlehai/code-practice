...
import com.fanlehai.hadoop.serialize.protocolbuffer.StockProtos.Stock;
...
public class StockProtocolBuffersFileReader {
	...
	public static void readFromProtoBuf(InputStream inputStream) throws IOException {
		...
		ProtobufBlockReader<Stock> reader = new ProtobufBlockReader<Stock>(inputStream, new TypeRef<Stock>() {
		});
