...
import com.fanlehai.hadoop.serialize.protocolbuffer.StockProtos.StockAvg;
...
public class StockAvgProtocolBuffersFileReader {
	...
	public static void readFromProtoBuf(InputStream inputStream) throws IOException {

		ProtobufBlockReader<StockAvg> reader = new ProtobufBlockReader<StockAvg>(inputStream, new TypeRef<StockAvg>() {
		});
