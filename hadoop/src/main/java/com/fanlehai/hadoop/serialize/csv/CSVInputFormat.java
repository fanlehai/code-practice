...
/**
 * An {@link org.apache.hadoop.mapreduce.InputFormat} for CSV plain text files.
 * Keys are byte offsets in the file, and values are
 * {@link org.apache.hadoop.io.ArrayWritable}'s with tokenized values.
 */
public class CSVInputFormat extends FileInputFormat<LongWritable, TextArrayWritable> {
	...
	public RecordReader<LongWritable, TextArrayWritable> createRecordReader(InputSplit split,
		...
		String csvDelimiter = HadoopCompat.getConfiguration(context).get( // <co
	...
	public static class CSVRecordReader // <co
		...
		@Override
		public TextArrayWritable getCurrentValue() // <co
