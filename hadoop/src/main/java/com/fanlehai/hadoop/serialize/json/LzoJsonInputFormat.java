 ...
 *
 * WARNING: The RecordReader-derived class used here may not handle multi-line
 * json well, if it all. Please improve this.
 */
public class LzoJsonInputFormat extends LzoInputFormat<LongWritable, MapWritable> {

	@Override
	public RecordReader<LongWritable, MapWritable> createRecordReader(InputSplit split, TaskAttemptContext taskAttempt)
