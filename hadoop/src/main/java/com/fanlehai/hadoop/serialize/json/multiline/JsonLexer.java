...
public class JsonLexer {
	...
	public static enum JsonLexerState {
		NULL, DONT_CARE, BEGIN_OBJECT, END_OBJECT, BEGIN_STRING, END_STRING, INSIDE_STRING, STRING_ESCAPE, VALUE_SEPARATOR, NAME_SEPARATOR, BEGIN_ARRAY, END_ARRAY, WHITESPACE
	}
