...
/*
 * input文件是json格式，且json的每一个object是多行的
 * 
 * hadoop jar hadoop.jar serialize.json.multiline.ExampleJob jsonm jsonmo
 * 
 * 
 */
...
/**
 * An example MapReduce job showing how to use the
 * {@link com.alexholmes.json.mapreduce.MultiLineJsonInputFormat}.
 */
public final class ExampleJob extends Configured implements Tool {
	...
	public static void main(final String[] args) throws Exception {
		...
		if (res != 0) {
			...
			System.out.println("ExampleJob is done !");
		}
	...
	/**
	 * JSON objects are supplied in string form to the mapper. Here we are
