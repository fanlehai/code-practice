...
public class JobChainingDriver extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new JobChainingDriver(), args);
		if (res != 0) {
			System.err.println("something bad happened !");
		} else {
			System.out.println("JobChainingDriver is done !");
		}
		System.exit(res);
	...
	public int run(String[] args) throws Exception {
		...
		FileSystem.get(getConf()).delete(outputDirIntermediate, true);
