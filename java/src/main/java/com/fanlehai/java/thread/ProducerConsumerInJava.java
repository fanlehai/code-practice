 ...
 * It will use wait() method when Queue is full and use notify() method 
 * to send notification to Consumer Thread.
 *  
 */
 ...
 * It will also use notify method to send  notification to producer thread 
 * after consuming values  from queue. 
 * 
 */
